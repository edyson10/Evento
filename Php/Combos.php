...
<form class="" action="../Php/RegistrarCombo.php" method="post" autocomplete="off">
<table align=center>
  <tr>
    <td>
      <div class="std">
        <h2 align=center>REGISTRAR COMBO</h2>
      </div>
    </td>
  </tr>
  <tr>
  ...
  <tr>
    <td>
      <div id="field_1" class="">
        ...
        <input type="number" name="Descuento"  id="field32" class="form-control input-text required-entry standard-matt-field  apellidos" style=" " value="">
      </div>
    </td>
  </tr>
  <tr>
...
<form class="" action="../Php/FormEditCombo.php" method="post" autocomplete="off">
<table align=center>
  <tr>
    <td>
...
<form class="" action="../Php/ListarCombos.php" method="post" autocomplete="off">
<table align=center>
  <tr>
    <td >
      <div class="std" align=center>
        <h2 align=center>LISTADO DE COMBOS</h2>
      </div>
      <h3>Filtrar por:</h3>
    </td>
  </tr>
  ...
  <tr>
    <td>
      <div class=" buttons-set" align=center>
        <br>
        <button type="submit" name="ListarCombos">BUSCAR</button>
      </div>
    </td>
  </tr>
</table>
