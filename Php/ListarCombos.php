    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="../html/Contacto.html" id="contactanos">Contacto</a>
			...
			<li class="nav-item">
				<a class="nav-link" href="../php/Combos.php" id="Regresar">Regresar</a>
			</li>
    </ul>
  </div>
  </div>
...
if(!isset($_POST["Nombre"],$_POST["Descuento"],$_POST["Estado"])
OR $_POST["Nombre"]!='' OR $_POST["Descuento"]!='' OR $_POST["Estado"]!='SELECCIONE' ){

//consulta inicial
	$consulta="SELECT *  FROM `combo` WHERE ";
...
echo "<tr><td colspan='5' alig='center'><h3 align=center>LISTADO DE COMBOS</h3></td></tr>";
echo "<tr><td ><h3 align=center >ID</h3></td>";
echo "<td><h3 align=center >NOMBRE</h3></td>";
echo "<td><h3 align=center >DESCUENTO</h3></td>";
echo "<td><h3 align=center >ESTADO</h3></td></tr>";
...
echo "</table>";
echo "<br><br><br>";
echo "<form  action='../php/Combos.php' method='post'>
