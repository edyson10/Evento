...
<!--Registro-->
<form class="" action="http://localhost/Pagina/Php/RegistrarAdmin.php" method="post" autocomplete="off">
<table align=center>
  <tr>
    <td>
      <div class="std">
        <h2 align=center>REGISTRAR <br> ADMINISTRADOR</h2>
      </div>
    </td>
  </tr>
  <tr>
  ...
  <tr>
    <td>
      <div id="field_32" class="">
        ...
        <input type="password" name="Contrasena" id="field32" class="form-control input-text required-entry standard-matt-field  apellidos" style=" " value="">
      </div>
    </td>
  </tr>
  <tr>
...
<form class="" action="http://localhost/Pagina/Php/FormEditAdmin.php" method="post" autocomplete="off">
<table align=center>
  <tr>
    <td>
...
<!--Registro-->
<form class="" action="http://localhost/Pagina/Php/ListarAdmin.php" method="post" autocomplete="off">
<table align=center>
  <tr>
    <td>
      <div class="std">
        <h2 align=center>LISTADO DE <br> ADMINISTRADORES</h2>
      </div>
      <h3>Filtrar por:</h3>
    </td>
  </tr>
