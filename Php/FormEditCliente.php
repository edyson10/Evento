...
if($_POST["Cliente"]=='SELECCIONE'){
  echo '<script>
    alert("Seleccione el cliente a editar")
    document.location="../php/Clientes.php"
   </script>';
 }else{
   $cliente=$_POST["Cliente"];
   $consulta="SELECT * FROM `cliente` WHERE Nombre='$cliente'  ";
...
<br><br><br><br><br>
  ...
  <form class="" action="http://localhost/Pagina/Php/EditarCliente.php" method="post" autocomplete="off">
    <table align=center>
      <tr>
        <td>
      ...
      <tr>
        <td>
          <div id="field_32">
            ...
            <?php
              $cedula=$cam["Cedula"];
              echo '<input type="text" name="Cedula" class="form-control input-text required-entry standard-matt-field  apellidos" value="'.$cedula.'">';
            ?>
          </div>
        </td>
      </tr>
