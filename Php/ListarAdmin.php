    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="../html/Contacto.html" id="contactanos">Contacto</a>
			...
			<li class="nav-item">
				<a class="nav-link" href="../php/Administradores.php" id="Regresar">Regresar</a>
			</li>
    </ul>
  </div>
  </div>
...
echo "<tr><td colspan='4' alig='center'><h3 align=center>LISTADO DE ADMINISTRADORES</h3></td></tr>";
...
echo "</table>";
echo "<br><br><br>";
echo "<form  action='../php/Administradores.php' method='post'>
